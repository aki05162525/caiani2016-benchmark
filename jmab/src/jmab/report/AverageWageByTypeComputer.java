...
/**
 * Computes the average wage (reservation wage) for a specific labor type.
 */
public class AverageWageByTypeComputer implements MacroVariableComputer {
